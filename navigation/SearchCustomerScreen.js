...
export default class SearchCustomerScreen extends React.Component {
  ...
  async componentDidMount() {
    ...
    const customers = await getCustomers(this.state.selectedCity, this.state.address);
